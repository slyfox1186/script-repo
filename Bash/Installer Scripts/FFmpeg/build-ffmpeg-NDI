...
source_flags_fn()
{
    ...
    CXXFLAGS='-g -O3 -march=native -DHWY_COMPILE_ONLY_SCALAR'
...
git_ver_fn '12072756' '3' 'B'
if build 'decklink' '12.7'; then
    download "https://github.com/slyfox1186/script-repo/raw/main/header-files/Blackmagic-DeckLink-SDK-12.7.tar.xz" 'decklink-12.7.tar.xz'
    for files in *.{h,cpp}
    do
