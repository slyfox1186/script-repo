...
start_aria2_fn()
{
    ...
    # CREATES THE REQUIRED DIRECTORIES INSIDE THE CURRENT USER'S HOME DIRECTORY
    ...
    # WHICH HAS BEEN CONFIGURED FOR THE DOWNLOADS FOR TO BE THE DEFAULT OUTPUT DIRECTORY WHEN RUNNING IN RPC MODE (WHICH I HIGHLY RECOMMEND USING)
