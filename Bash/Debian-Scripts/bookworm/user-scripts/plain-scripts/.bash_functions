...
imdl() {
    ...
    cd "$tmp_dir" || exit 1
    curl -A "$user_agent" -Lso 'imow' 'https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/ImageMagick/scripts/optimize-and-overwrite.sh'
    sudo mv imow "$cwd"
    sudo rm -fr "$tmp_dir"
    cd "$cwd" || exit 1
...
dlfs() {
    ...
    wget --show-progress -U "$user_agent" -qN - -i 'https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/SlyFox1186-Scripts/favorite-installer-scripts.txt'
...
dl_clang() {
    ...
    wget --show-progress -U "$user_agent" -cqO "$HOME/tmp/build-clang-16" 'https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/GitHub-Projects/build-clang-16'
    wget --show-progress -U "$user_agent" -cqO "$HOME/tmp/build-clang-17" 'https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/GitHub-Projects/build-clang-17'
