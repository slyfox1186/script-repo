...
cat > "$tf" <<'EOF'
https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Raspbian-OS/user-scripts/.bashrc
https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Raspbian-OS/user-scripts/.bash_aliases
https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Raspbian-OS/user-scripts/.bash_functions
EOF
