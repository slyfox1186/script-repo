...
impl SuggestionEngine {
    fn new() -> Self {
        let patterns = vec![
            ...
            ErrorPattern {
                ...
                suggestions: vec![
                    Suggestion {
                        ...
                        description: "GCC requires MPFR (Multiple Precision Floating-Point) library".to_string(),
                        commands: vec![
                            "# Ubuntu/Debian:".to_string(),
            ...
            ErrorPattern {
                ...
                suggestions: vec![
                    Suggestion {
                        ...
                        description: "GCC requires MPC (Multiple Precision Complex) library".to_string(),
                        commands: vec![
                            "# Ubuntu/Debian:".to_string(),
            ...
            ErrorPattern {
                name: "out_of_memory",
                regex: Regex::new(r"(?i)out of memory|memory exhausted|cannot allocate|oom|killed.*signal 9").unwrap(),
                suggestions: vec![
                    Suggestion {
                        title: "Reduce parallel jobs".to_string(),
                        description: "The build ran out of memory. Try reducing parallelism.".to_string(),
                        commands: vec![
                    ...
                    Suggestion {
                        ...
                        description: "Consider adding temporary swap space for the build".to_string(),
                        commands: vec![
            ...
            ErrorPattern {
                ...
                suggestions: vec![
                    Suggestion {
                        ...
                        description: "The build requires significant disk space (25GB+ per version)".to_string(),
                        commands: vec![
            ...
            ErrorPattern {
                ...
                regex: Regex::new(r"(?i)permission denied|EACCES|cannot create.*directory").unwrap(),
                suggestions: vec![
                    Suggestion {
                        title: "Check directory permissions".to_string(),
                        description: "Ensure you have write permissions to the installation directory".to_string(),
                        commands: vec![
            ...
            ErrorPattern {
                name: "network_error",
                regex: Regex::new(r"(?i)connection.*refused|timeout|could not resolve|network.*unreachable").unwrap(),
                suggestions: vec![
                    Suggestion {
                        title: "Check network connectivity".to_string(),
                        description: "Unable to download files. Check your internet connection.".to_string(),
                        commands: vec![
            ...
            ErrorPattern {
                ...
                suggestions: vec![
                    Suggestion {
                        ...
                        description: "GCC requires a specific ISL version for Graphite optimizations".to_string(),
                        commands: vec![
    ...
    pub fn format_suggestions(suggestions: &[Suggestion]) -> String {
        ...
        for (i, suggestion) in suggestions.iter().enumerate() {
            ...
            output.push_str(&format!("\n{} {}. {}\n", severity_icon, i + 1, suggestion.title));
