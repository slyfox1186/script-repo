...
# GitHub: https://github.com/slyfox1186/script-repo/blob/main/Bash/Installer-Scripts/GNU-Software/build-bash.sh
...
uninstall_bash() {
    local bash_dir
    bash_dir="$install_dir/$archive_name"
    if [[ -d "$bash_dir" ]]; then
        log "Uninstalling $prog_name from $bash_dir"
        sudo rm -rf "$bash_dir"
