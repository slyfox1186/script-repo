...
install_autoconf() {
    if [[ ! -x "/tmp/autoconf-2.69/bin/autoconf" ]]; then
        ...
        wget -cqO "/tmp/autoconf-2.69/build-autoconf.sh" "https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/GNU-Software/build-autoconf.sh"
