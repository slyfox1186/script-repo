...
download_menu() {
    ...
    if [[ "$os" == "arch" ]]; then
        ...
        execution_menu "https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/Arch-Linux/reflector-mirror-speed-test.sh" "reflector_mirror_test.sh"
        return 0
    fi
