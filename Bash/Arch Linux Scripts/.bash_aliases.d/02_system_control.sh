...
alias psarch='clear; uname -m'
alias psusb='lsblk -a | sort > ~/usb.txt'
alias showarch='uname -m'
alias uver="clear; grep PRETTY_NAME /etc/os-release | cut -d= -f2- | tr -d '\"'"
...
# Copy this advanced command with exclude file capability
alias cpt='copy_this'
