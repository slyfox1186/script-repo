...
imow() {
    if wget --timeout=2 --tries=2 -cqO "optimize-jpg.py" "https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/ImageMagick/scripts/optimize-jpg.py"; then
        clear
...
ffdl() {
    wget -cqO "loop-ffpb.sh" "https://raw.githubusercontent.com/slyfox1186/script-repo/main/Bash/Installer-Scripts/FFmpeg/run-scripts/convert-x264-to-x265-cuda-arch-linux.sh"
