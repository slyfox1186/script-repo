...
# Script version: 1.0
# Updated: 01.08.24
# Url: https://github.com/slyfox1186/script-repo/blob/main/Bash/Installer-Scripts/GitHub-Projects/build-opencl-sdk
...
sudo rm -fr "$cwd/$archive_name"

# Clone the repository
if ! git clone --recursive "$archive_url" "$cwd/$archive_name"; then
    echo "Clone failed"
    exit 1
fi
